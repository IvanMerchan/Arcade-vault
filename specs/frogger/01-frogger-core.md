...
- [x] La card de Frogger aparece en `/games` con cover `cover-frogger` y color `lime`.
- [x] La ruta `/games/frogger/play` carga sin errores de SSR ni de TypeScript.
...
- [x] El score guardado aparece en `/games/frogger` y en `/hall-of-fame` al recargar.
